...
Como se puede ver en el gráfico, el hecho de operar ya con dos dimensiones sería suficiente, puesto que ya estaríamos obteniendo más del 80% de la variabilidad y es fácilmente representable. Si siguiéramos la regla del codo, tendríamos que coger 3 dimensiones.
...
Aquí vemos la correlación, segmentada por dimensión, basándonos en el cos2.
...
Podemos ver las calidades de la representación (cos2) vistas de manera analítica en un gráfico de barras. Como se puede observar, las mejor representadas son "hombres", "sano" y "mujeres", mientras que "feo" es la peor representada. Esto es para las dimensiones 1 y 2.
...
En cambio, para la dimensión 2, se observa que casi todas las variables están juntas excepto horsepower.En esta dimensión tiene sentido que a mayor anchura y distnacia entre ejes mayor curva tenga que hacer en U, y a mayor precio que tenga un mayor motor en caballos. Además, en esta dimensión el consumo aumenta con el aumento de caballos, lo cual también tiene sentido.
